      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl mt-lg px-gutter max-w-container-max mx-auto mb-xl">
        ...
        <div className="lg:col-span-7 space-y-gutter">
          <div className="aspect-[4/5] rounded-xl overflow-hidden bg-surface-container shadow-sm group">
            <img alt={product.nama} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src={product.gambar} />
          </div>
          <div className="grid grid-cols-2 gap-gutter">
            <div className="aspect-square rounded-xl overflow-hidden bg-surface-container">
              <img alt="Detail 1" className="w-full h-full object-cover hover:opacity-90 transition-opacity cursor-pointer" src={product.gambar} />
            </div>
            <div className="aspect-square rounded-xl overflow-hidden bg-surface-container">
              <img alt="Detail 2" className="w-full h-full object-cover hover:opacity-90 transition-opacity cursor-pointer" src={product.gambar} />
            </div>
          </div>
        </div>
